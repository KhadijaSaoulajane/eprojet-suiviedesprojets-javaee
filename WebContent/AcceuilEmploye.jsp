...
<%
	List<Taches> taches = tache.getTaches(e.getIdEmpl());
%>

					<div class="widget-header">
						<i class="icon-th-list"></i>
						<h2 style="text-align:center; padding-top:10px; font-size:20px">Liste des tâches</h2>
