...
<body>
    ...
    <label>Id</label>
    <input style="margin-bottom:1%" type="text" name="codeE" class="form-control " >
    <label>Nom</label>
    <input style="margin-bottom:1%" type="text" name="nom" class="form-control" required>
    <label>Description</label>
    <input style="margin-bottom:1%" type="text" name="desc" class="form-control" required>
   
			    <input style="margin-top:2%; margin-left:1%" type="submit" name="addE" value="Ajouter" class="btn btn-success pull-right">
