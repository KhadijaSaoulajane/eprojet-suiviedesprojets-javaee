...
<% Projet p = projet.getProjetByCode(request.getParameter("id")); %>
 <h2>Modifier Projet : <%= p.getCodePro() %> </h2>
    <form action="ProjetSer" method="POST">
    <label>Code projet</label>
    <input style="margin-bottom:1%" type="text" name="code" class="form-control" value="<%= p.getCodePro() %>" >
    <label>Nom</label>
    <input style="margin-bottom:1%" type="text" name="nom" class="form-control " value="<%= p.getNomPro() %>" >
    <label>Description</label>
    <input style="margin-bottom:1%" type="text" name="description" class="form-control" value="<%= p.getDescriptionPro() %>" >
   <label>Charge Horaire (Nombre d'heures)</label>
    <input style="margin-bottom:1%" type="text" name="chargeH" class="form-control" value="<%= p.getChargeHorairePro() %>" >
   
			    <input style="margin-top:2%; margin-left:1%" type="submit" name="updateP" value="Modifier" class="btn btn-success pull-right">
