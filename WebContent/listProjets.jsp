...
<head>
    ...
    <title>Liste Projets trouvés</title>
      ...
      <nav style="border:1px groove #ff0000;"  id="nav-menu-container">
        <ul  class="nav-menu">
          <li ><a style="color:red; " href="DeconnectSer">Se déconnecter</a></li>
            ...
            <h2 style="text-align:center; margin-top:8% ">Résultat de la recherche sur projets : </h2>
        ...
        <div class="container">
            ...
            <div class="span7">
                <div class="widget stacked widget-table action-table">
                      <% List<Projet> projets = (List<Projet>) session.getAttribute("ProjetTrouve"); %>
